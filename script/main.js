...
window.setInterval(function () {
  ...
  if (txt1.innerText == "SebastianDev") {
    ...
    txt2.innerHTML =
      "Desarrollador de software en diferentes areas como Sitios web / Aplicaciones de Escritorio / Aplicaciones Moviles, segun lo requerido por el cliente.";
    ...
    txt2.innerHTML = "Desarrollador de Software";
